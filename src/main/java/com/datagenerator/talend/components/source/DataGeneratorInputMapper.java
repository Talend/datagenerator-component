...
public class DataGeneratorInputMapper implements Serializable {
    ...
    @Split
    public List<DataGeneratorInputMapper> split(@PartitionSize final long bundles) {
        ...
        // In this case bundles = 100 and we must try to return 10 DataGeneratorInputMapper with 1/10 of the overall work each.
        //
    ...
    @Emitter
    public DataGeneratorInputSource createWorker() {
        // here we create an actual worker,
        // you are free to rework the configuration etc but our default generated implementation
        // propagates the partition mapper entries.
        return new DataGeneratorInputSource(configuration, service, recordBuilderFactory);
    }
}